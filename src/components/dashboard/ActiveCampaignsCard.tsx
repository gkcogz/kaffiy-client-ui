...
const mockCampaigns: Campaign[] = [
  {
    id: "1",
    name: "Özel Teklif",
    description: "14:00–17:00 arası %10 indirim",
    status: "active",
    daysLeft: 3,
    reach: 245,
    conversions: 34,
  ...
  {
    id: "2",
    name: "Hafta Sonu Mutluluğu",
    description: "Cumartesi-Pazar 2. kahve bedava",
    status: "active",
    daysLeft: 5,
    reach: 189,
    conversions: 28,
  ...
  },
  {
    id: "3",
    name: "Sadakat Bonusu",
    description: "10 damga toplayan +2 damga kazanır",
    status: "paused",
    daysLeft: 12,
    reach: 420,
    conversions: 67,
